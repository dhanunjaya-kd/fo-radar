...
// per this file's own existing footer text below), NOT a reuse of
// NSE's 9:15-15:30 window -- that would be wrong for an MCX
// instrument. Tested in test_mcx_status.js (9 cases, including the
// near-midnight close that NSE's hours never had to handle).
...
const CONTRACTS = [
  { id: 'CRUDEOIL', label: 'Crude Oil (Standard)' },
  { id: 'CRUDEOILM', label: 'Crude Oil Mini' },
];
...
// blank: crude oil has no separate spot/cash index, and here (unlike the
...
export default function CrudeOilTracker() {
  const [contractId, setContractId] = useState('CRUDEOIL');

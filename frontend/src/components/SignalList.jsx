...
export default function LiveSignals() {
  ...
  return (
    <div className="space-y-3">
      {/* A/D is deliberately the first block: compact, fixed-width and
          visually separated from the signal title, matching the requested
          left-hand layout rather than sitting after SNIPER Signals. */}
      <div className="flex items-center gap-3 min-h-[70px]">
        <div className="w-[255px] h-[70px] shrink-0 flex items-center px-3 rounded-lg bg-slate-900/60 border border-slate-800">
          <div className="w-[55px] shrink-0 text-[9px] text-slate-500 uppercase tracking-wider leading-tight text-center">
            <div>A/D</div>
            <div className="text-[8px]">BREADTH</div>
          </div>
          <div className="h-10 border-l border-slate-800 mx-2" />

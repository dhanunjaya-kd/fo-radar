        ...
        <div className="flex items-center gap-2">
          {rows.length > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 text-[11px] bg-slate-800 border border-slate-700 text-slate-300 hover:text-white hover:border-slate-500 rounded-lg px-2.5 py-1 transition-colors"
            >
              <DownloadIcon />

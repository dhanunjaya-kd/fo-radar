...
from screener.views import (
    ...
    SignalWatchlistCsvView, IndexSignalView, CommodityCurrentSymbolView, CommodityQuoteView, MarketBreadthView, TodaysMoversView, IndexCardView,
...
urlpatterns = [
    ...
    path('api/index-agreement-log/', IndexAgreementLogView.as_view(), name='index_agreement_log'),
